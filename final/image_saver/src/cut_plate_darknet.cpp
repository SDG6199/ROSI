...
// void ImageSaveCb(const sensor_msgs::Image)
// {
...
// // void ImagePix(const darknet_ros_msgs::BoundingBoxes::ConstPtr& msg)
// // {
// //     int saved_img=0;
...
//     ros::NodeHandle nh;
//     ros::Subscriber sub_img=nh.subscribe("/camera/color/image_raw",5,ImageSaveCb);
//     //ros::Subscriber sub_img_pix=n.subscribe("/darknet_ros_3d/boundingboxes",1000,ImagePix);
//     ros::spin();
