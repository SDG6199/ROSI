...
while 1:
    ...
    if (MY_DXL == 'XL320'): # XL320 uses 2 byte Position Data, Check the size of data in your DYNAMIXEL's control table
        ...
        dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, DXL_ID, ADDR_GOAL_VELOCITY, dxl_goal_velocity[index])
    ...
    while 1:
        ...
        print("[ID:%03d] Goalvel:%03d  PresPos:%03d" % (DXL_ID, dxl_goal_velocity[index], dxl_present_position))
